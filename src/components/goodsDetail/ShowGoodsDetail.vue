              ...
              <div class="item-intro-img" ref="itemIntroGoods">
                ...
                <Card v-for="(item,index) in detailArray" style="width:32%;margin: 5px">
                  <Tooltip placement="top">
                    <div slot="content">
                      <Row>
                        <p>雪茄名:{{item.cigar_name}}</p>

                        <p>{{(item.argument.split(";")[0]).replace(",",":")}}</p>
                        ...
                        <p>国内单支售价
                          :{{item.price_single_china}}</p>
                        <p>国内一盒售价
                          :{{item.price_box_china}}</p>
                        <p>香港单支售价
                          :{{item.price_single_hongkong}}</p>
                        <p>香港一盒售价
                          :{{item.price_box_hongkong}}</p>
                        <p>海外单支售价
                          :{{item.price_single_overseas}}</p>
                        <p>海外一盒售价
                          :{{item.price_box_overswas}}</p>
                        <p>香港店名
                          :{{item.store_hongkong}}</p>
                        <p>海外店名
                          :{{item.store_overseas}}</p>

                      </Row>
                    </div>
                    <div style="text-align:left">
                      <img :src="item.photo_list[0].photo_url" style="width:100%;height: auto;">
                      <h3>{{item.index}}</h3>
                    </div>
